...
class UserSignalTest(BaseTestSetup, TestCase):
    ...
    def testShouldReturnTrueWhenProfileCreatedProperlyForBasicUser(self):
        new_basic_user = User.objects.create_user(**self.test_basic_user)
    ...
    def testShouldReturnTrueWhenProfileCreatedProperlyForPremiumUser(self):
        new_premium_user = User.objects.create_user(**self.test_premium_user)
    ...
    def testShouldReturnTrueWhenProfileCreatedProperlyForEnterpriseUser(self):
        new_enterprise_user = User.objects.create_user(**self.test_enterprise_user)
    ...
    def testShouldReturnTrueWhenProfileCreatedProperlyForCustomUser(self):
        new_custom_user = User.objects.create_user(**self.test_custom_user)
        custom_user_profile = Profile.objects.get(user=new_custom_user.id)
        thumbnail_sizes = list(
